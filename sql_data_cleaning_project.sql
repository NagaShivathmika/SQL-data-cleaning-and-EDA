...
-- Copying the raw data into another table --
...
-- writing the above as cte's and to view duplicates--
...
-- cross checking the duplicates --

SELECT * FROM layoffs_staging
WHERE company = 'Yahoo';

-- creating a new table with the row_num --
